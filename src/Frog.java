...
public class Frog extends EntityAnimated {

    public static final String QUAKE_KEY = "quake";

    public Frog(String id, Point position, List<PImage> images, int resourceLimit,
                 int resourceCount, int actionPeriod, int animationPeriod) {
        super(id, position, images, resourceLimit, resourceCount, actionPeriod, animationPeriod);
    }

    public void executeFrogActivity(WorldModel world, ImageStore imageStore, EventScheduler scheduler) {
        ...
        if (moveToFrog(world, (Entity)target, scheduler)) {
    ...
    public boolean moveToFrog(WorldModel world, Entity target, EventScheduler scheduler) {
    ...
    public void transformToFrog(Point p, WorldModel world, EventScheduler scheduler, ImageStore imageStore)
    {
        try {
            Miner_Full miner = new Miner_Full(this.getId(), this.getPosition(), this.getImages(), 0, 0, this.getActionPeriod(), 0);
